...
import com.test.cloud.leaf.id.model.SegmentBufferView;
import com.test.cloud.leaf.id.segment.SegmentIDGenImpl;
import com.test.cloud.leaf.id.segment.model.LeafAlloc;
import com.test.cloud.leaf.id.segment.model.SegmentBuffer;
...
public class LeafMonitorController {
    ...
    public String getCache(Model model) {
        ...
        SegmentIDGenImpl segmentIDGen = (SegmentIDGenImpl)segmentService.getIdGen();
